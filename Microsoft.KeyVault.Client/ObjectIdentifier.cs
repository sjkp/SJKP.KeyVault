...
namespace Microsoft.KeyVault.Client
{
    ...
    {
        public KeyIdentifier( string vault, string name, string version = null ) : base( vault, "keys", name, version )
        {
        }

        public KeyIdentifier( string identifier ) : base( "keys", identifier )
        {
        }
    }
    ...
    {
        public SecretIdentifier( string vault, string name, string version = null ) : base( vault, "secrets", name, version )
        {
        }

        public SecretIdentifier( string identifier ) : base( "secrets", identifier )
        {
        }
    }
}